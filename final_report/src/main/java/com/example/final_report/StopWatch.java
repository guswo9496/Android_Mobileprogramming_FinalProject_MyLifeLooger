...
public class StopWatch extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.back_to_task).setOnClickListener(backtotaskClickListener);
  }
  @Override
  ...
  Button.OnClickListener backtotaskClickListener = new View.OnClickListener(){
    ...
    public void onClick(View view) {
      switch (view.getId()){
        ...
        case R.id.time_save:
          Intent timesave = new Intent();
          timesave.putExtra(tim,"저장");
          setResult(RESULT_OK,timesave);
          finish();
          break;
        case R.id.back_to_task:
          Intent back_to_task =new Intent(StopWatch,TaskActivity.class);
          startActivity(back_to_task);
          break;
      }
    }
  };
